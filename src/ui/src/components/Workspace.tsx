...
// и клиент не понимал, что произойдёт по нажатию (ARCHITECTURE.md).
...
/** Карточки на стартовом экране (ARCHITECTURE.md).
 *
...
/* Пустой список и отсутствие блока выглядели одинаково: клиент не мог понять,
   рисков нет или они не подгрузились (ARCHITECTURE.md). Поэтому пустоту
...
/** Стартовый экран (ARCHITECTURE.md).
 *
