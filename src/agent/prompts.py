...
14. Каждый пункт называет, ЧТО именно нашлось. «Выявленное несоответствие», «есть негативные факторы», «обнаружены риски» — так нельзя: пользователь не узнал ничего. Расхождения приходят готовым текстом — бери его. Так нужно: «Светофор зелёный, но есть активные исполнительные производства: 54 шт.», «Отчётность за три года не раскрыта»."""
